...
insert into user(username,password) values ('admin','$2a$10$ETQGzL9FxSbbr97HzWG/hOki3H5ZP7s6EhyYI9jy8OL5Mxk6J9IWa');
insert into user(username,password) values ('user','$2a$10$ja/FVCHP.N2PpLwV4qozOemUYj844c8dwv39CRrRYOrzv7n4sTwda');
