...
public interface ComputerDTOValidator {
     ...
     */
    static void validate(ComputerDTO dto) throws IntegrityException {
        ...
        if (dto.getDiscontinuedDate() != null && dto.getIntroducedDate() != null
            ...
            throw new IntegrityException(
                    "Discontinued date cannot be earlier than introducing datefor computer "
                            + dto.getName());
        }
    }
     ...
     * @throws IntegrityException thrown if the integrity is not respected
     */
    static void validate(List<ComputerDTO> list) throws IntegrityException {
